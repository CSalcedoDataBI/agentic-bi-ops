...
|---|---|
| `/board` | Administer/automate a GitHub Projects board (work/init/add/move/field/bulk/fill/automate/handoff). Defaults to the CSalcedoDataBI account. |
...
<sub>agentic-board <!-- BEGIN:version -->v0.19.0<!-- END:version --> · docs generated by `plugins/agentic-board/scripts/Update-Docs.ps1`</sub>
